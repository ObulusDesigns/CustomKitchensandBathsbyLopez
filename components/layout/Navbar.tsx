        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/blog" className="text-white hover:text-gold transition-colors duration-300 font-medium">
                Blog
              </Link>
              <Link href="/about" className="text-white hover:text-gold transition-colors duration-300 font-medium">
                About Us
              </Link>
              <Link href="/contact" className="text-white hover:text-gold transition-colors duration-300 font-medium">
                Contact
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              {/* CTA Button */}
              <Link href="/contact" className="bg-white text-burgundy px-6 py-2.5 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 shadow-md hover:shadow-lg">
                Get Free Quote
              </Link>
            </div>
        ...
        <>
          ...
          <div className={`fixed top-0 right-0 w-72 h-full bg-burgundy-dark shadow-2xl z-50 lg:hidden transform transition-transform duration-300 ${
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <Link href="/blog" className="block text-white hover:text-gold transition-colors duration-200 font-medium">
                Blog
              </Link>
              <Link href="/about" className="block text-white hover:text-gold transition-colors duration-200 font-medium">
                About Us
              </Link>
              <Link href="/contact" className="block text-white hover:text-gold transition-colors duration-200 font-medium">
                Contact
              </Link>
              ...
              <div className="pt-6 space-y-4 border-t border-white/20">
                ...
                <Link href="/contact" className="block w-full bg-white text-burgundy px-6 py-3 rounded-lg font-semibold text-center hover:bg-gray-100 transition-all duration-300">
                  Get Free Quote
                </Link>
              </div>
            </div>
